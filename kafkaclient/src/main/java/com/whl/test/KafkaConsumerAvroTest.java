...
public class KafkaConsumerAvroTest implements Runnable{
    private KafkaStream m_stream;
    private int m_threadNumber;

    public KafkaConsumerAvroTest(KafkaStream a_stream, int a_threadNumber) {
    ...
    public void run(){
        ...
        while(it.hasNext())
        {
            try {
                ...
                Schema schema = null;
                schema = new Schema.Parser().parse(new File("src/main/resources/test_schema.avsc"));
